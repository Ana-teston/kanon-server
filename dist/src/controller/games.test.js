  ...
  ;(0, globals_1.describe)('getGames', () => {
    ;(0, globals_1.test)('It should return a JSON response with games', () => {
      ...
      ;(0, globals_1.expect)(res.json).toHaveBeenCalledWith({
        games: globals_1.expect.any(Array),
      })
    })
  })
  ;(0, globals_1.describe)('getGameById', () => {
    ;(0, globals_1.test)(
      'It should return a JSON response with the specified game',
      () => {
        const req = {
        ...
        ;(0, globals_1.expect)(res.json).toHaveBeenCalledWith({
          game: globals_1.expect.any(Object),
        })
      }
    )
    ;(0, globals_1.test)(
      'It should return a 404 error if the game is not found',
      () => {
        const req = {
        ...
        ;(0, globals_1.expect)(() =>
          games_controller_1.default.getGameById(req, res)
        ).toThrow(exceptions_1.GameNotFoundException)
      }
    )
  })
})
