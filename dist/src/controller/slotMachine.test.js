...
jest.mock('../../data/userCoins', () =>
  Object.assign(Object.assign({}, jest.requireActual('../../data/userCoins')), {
...
describe('Slot Machine Controller', () => {
  ...
  it('should return correct spin result and coins won', () =>
  ...
  it('should handle coins deduction and update correctly', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      expect(userCoinsModule.setUserCoins).toHaveBeenCalledWith(
        expect.any(Number)
      )
    }))
})
